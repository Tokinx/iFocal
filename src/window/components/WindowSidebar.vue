<template>
  <aside class="w-60 shrink-0">
    <div class="flex h-full min-h-0 flex-col gap-2">
      ...
      <div class="p-3 rounded-1xl space-y-2 bg-white border border-olive-300/60 shadow-xs">
        <div v-for="item in tasks" :key="item.id" role="button" tabindex="0"
          ...
          :class="activeRouteName !== 'settings' && activeAssistantId === item.id ? '!bg-amber-700/90 !text-white' : 'text-foreground'"
